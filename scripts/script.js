...
window.addEventListener('DOMContentLoaded', function () {
    ...
    if (user) {
        ...
        document.getElementById('welcomeMessage').textContent =`welcome ${JSON.stringify(user['username'])}`;
    } else {
...
window.addEventListener('DOMContentLoaded', function () {
    ...
    if (user) {
        document.querySelectorAll('.login-link, .signup-link').forEach(el => el.style.display = 'none');
